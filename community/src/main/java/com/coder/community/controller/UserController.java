...
//        // 上传文件名称(随机生成，避免覆盖, 或者服务器缓存不立刻刷新)
//        String fileName = CommunityUtil.generateUUID();
//        // 设置响应信息   成功的时候返回 code:0
...
//    }
    ...
    public String uploadHeader(MultipartFile headerImage, Model model) {
        ...
        // /Users/hcj/Desktop/GraduationProject/community/src/main/resources/static/user-avatar
    ...
    public String getMyPost(@PathVariable("userId") int userId, Page page, Model model) {
        ...
        List<DiscussPost> discussList = discussPostService
                .findDiscussPosts(userId, page.getOffset(), page.getLimit(), 0, 0);
